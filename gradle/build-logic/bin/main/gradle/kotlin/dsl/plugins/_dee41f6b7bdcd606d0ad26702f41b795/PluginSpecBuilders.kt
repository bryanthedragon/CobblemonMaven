...
package gradle.kotlin.dsl.plugins._dee41f6b7bdcd606d0ad26702f41b795
...
/**
 * The `dev.architectury.loom` plugin implemented by [net.fabricmc.loom.LoomGradlePlugin].
 */
internal
...
/**
 * The `net.kyori.blossom` plugin implemented by [net.kyori.blossom.Blossom].
 */
internal
val `NetKyoriPluginGroup`.`blossom`: PluginDependencySpec
    get() = plugins.id("net.kyori.blossom")
